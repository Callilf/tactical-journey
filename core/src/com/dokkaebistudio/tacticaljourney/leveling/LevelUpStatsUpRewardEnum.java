...
public enum LevelUpStatsUpRewardEnum {
	...
	private LevelUpStatsUpRewardEnum(String desc, String finalDesc) {
		this.setDescription(desc);
		this.setFinalDescription(finalDesc);
	}
	
	private LevelUpStatsUpRewardEnum(Integer valueMin, Integer valueMax, String desc, String finalDesc) {
